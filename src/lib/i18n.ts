...
const translations: Record<Locale, Record<string, string>> = {
	en: {
		...
		'page.error': 'Error:',
		'page.issues': 'This form cannot be converted:',
		'page.warnings': 'Converted, but check these points:',
		'page.result': 'Result',
	...
	de: {
		...
		'page.error': 'Fehler:',
		'page.issues': 'Dieses Formular kann nicht umgewandelt werden:',
		'page.warnings': 'Umgewandelt, aber bitte diese Punkte prüfen:',
